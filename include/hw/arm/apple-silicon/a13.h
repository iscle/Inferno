...
typedef struct AppleA13State {
    ...
    A13_CPREG_VAR_DEF(PMC2);
    A13_CPREG_VAR_DEF(PMC3);
    A13_CPREG_VAR_DEF(PMC4);
    A13_CPREG_VAR_DEF(PMC5);
    A13_CPREG_VAR_DEF(PMC6);
    A13_CPREG_VAR_DEF(PMC7);
    A13_CPREG_VAR_DEF(PMC8);
    A13_CPREG_VAR_DEF(PMC9);
    A13_CPREG_VAR_DEF(PMCR0);
    A13_CPREG_VAR_DEF(PMCR1);
    A13_CPREG_VAR_DEF(PMCR2);
    A13_CPREG_VAR_DEF(PMCR3);
    A13_CPREG_VAR_DEF(PMCR4);
    A13_CPREG_VAR_DEF(PMESR0);
    A13_CPREG_VAR_DEF(PMESR1);
    A13_CPREG_VAR_DEF(OPMAT0);
    A13_CPREG_VAR_DEF(OPMAT1);
    A13_CPREG_VAR_DEF(OPMSK0);
    A13_CPREG_VAR_DEF(OPMSK1);
    A13_CPREG_VAR_DEF(PMTRHLD6);
    A13_CPREG_VAR_DEF(PMTRHLD4);
    A13_CPREG_VAR_DEF(PMTRHLD2);
    A13_CPREG_VAR_DEF(PMMMAP);
