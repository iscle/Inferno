...
static const ARMCPRegInfo apple_a13_cp_reginfo_tcg[] = {
    ...
    A13_CPREG_DEF(PMC3, 3, 2, 15, 3, 0, PL1_RW, 0),
    A13_CPREG_DEF(PMC4, 3, 2, 15, 4, 0, PL1_RW, 0),
    A13_CPREG_DEF(PMC5, 3, 2, 15, 5, 0, PL1_RW, 0),
    A13_CPREG_DEF(PMC6, 3, 2, 15, 6, 0, PL1_RW, 0),
    A13_CPREG_DEF(PMC7, 3, 2, 15, 7, 0, PL1_RW, 0),
    A13_CPREG_DEF(PMC8, 3, 2, 15, 9, 0, PL1_RW, 0),
    A13_CPREG_DEF(PMC9, 3, 2, 15, 10, 0, PL1_RW, 0),
    A13_CPREG_DEF(PMCR0, 3, 1, 15, 0, 0, PL1_RW, 0),
    A13_CPREG_DEF(PMCR1, 3, 1, 15, 1, 0, PL1_RW, 0),
    A13_CPREG_DEF(PMCR2, 3, 1, 15, 2, 0, PL1_RW, 0),
    A13_CPREG_DEF(PMCR3, 3, 1, 15, 3, 0, PL1_RW, 0),
    A13_CPREG_DEF(PMCR4, 3, 1, 15, 4, 0, PL1_RW, 0),
    A13_CPREG_DEF(PMESR0, 3, 1, 15, 5, 0, PL1_RW, 0),
    A13_CPREG_DEF(PMESR1, 3, 1, 15, 6, 0, PL1_RW, 0),
    A13_CPREG_DEF(OPMAT0, 3, 1, 15, 7, 0, PL1_RW, 0),
...
static const VMStateDescription vmstate_apple_a13 = {
    ...
    .fields =
        (const VMStateField[]){
            ...
            VMSTATE_A13_CPREG(PMC2),
            VMSTATE_A13_CPREG(PMC3),
            VMSTATE_A13_CPREG(PMC4),
            VMSTATE_A13_CPREG(PMC5),
            VMSTATE_A13_CPREG(PMC6),
            VMSTATE_A13_CPREG(PMC7),
            VMSTATE_A13_CPREG(PMC8),
            VMSTATE_A13_CPREG(PMC9),
            VMSTATE_A13_CPREG(PMCR0),
            VMSTATE_A13_CPREG(PMCR1),
            VMSTATE_A13_CPREG(PMCR2),
            VMSTATE_A13_CPREG(PMCR3),
            VMSTATE_A13_CPREG(PMCR4),
            VMSTATE_A13_CPREG(PMESR0),
            VMSTATE_A13_CPREG(PMESR1),
            VMSTATE_A13_CPREG(OPMAT0),
